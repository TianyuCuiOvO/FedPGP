...
#              DIR=output_base/dtd_mu0/reparaFL_Repara_8neck/vit_b16_8shots/nctx16_cscFalse_ctpend/iid_False_10users_1frac_lr0.001_25round_seed0
        ...
        if [ -d "$DIR" ]; then
          echo "The results exist at ${DIR} (go test base acc now)"
